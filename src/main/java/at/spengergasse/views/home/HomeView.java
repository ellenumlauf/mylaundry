...
public class HomeView extends VerticalLayout {
    ...
    public HomeView() {
        ...
        FlexLayout totalInfo = new FlexLayout();
        ...
        //line1.setWidth("400px");

        line1.getStyle()
            .set("font-size", "18px")
            .set("line-height", "1.4")
            .set("text-align", "left");
        //line2.setWidth("300px");
        line2.getStyle()
            .set("font-size", "18px")
            .set("line-height", "1.4")
            .set("text-align", "left");
        //line3.setWidth("400px");
        line3.getStyle()
            .set("font-size", "18px")
            .set("line-height", "1.4")
            .set("text-align", "left");

        info.add(line1, line2, line3);
        ...
        totalInfo.add(logo, info);
        totalInfo.setWidthFull();
        totalInfo.setJustifyContentMode(JustifyContentMode.CENTER);
        totalInfo.setAlignItems(FlexComponent.Alignment.START);
        totalInfo.setFlexWrap(FlexLayout.FlexWrap.WRAP);
        add(totalInfo);

        add(header, totalInfo, name, street, city);
    }
    public static VerticalLayout getHeader() {
        ...
        H1 companyName = new H1("SUPERCLEAN");
